...
newspapers.forEach((newspaper) => {
  /**
   * scrape each site for any link that contains the word 'climate'
   * then save the title and url as an object in articles[]
   *
   */
...
app.get('/news', (req, res) => {
  res.json(articles);
  /**
   * scrape a site for any link that contains the word 'climate'
   * then save the title and url as an object in articles[]
   *
   */
...
app.get('/news/:newspaperId', (req, res) => {
   ...
   * from the publication by :newspaperId
   *
   */
